 ...
 * planner.
 */
public abstract class PlayerCharacter : MonoBehaviour, IGoap
{
    ...
    public HashSet<KeyValuePair<string, object>> getWorldState()
    {
        ...
        worldData.Add(new KeyValuePair<string, object>("hasPrimary", (backpack.weapon != null)));
        worldData.Add(new KeyValuePair<string, object>("hasSecondary", (backpack.tool != null)));
    ...
    public bool moveAgent(GoapAction nextAction)
    {
        ...
        //gameObject.transform.forward = nextAction.transform.position - transform.position;
